 ...
 * License: ISC
 *
 * Generated at Monday, July 31st, 2017, 11:04:35 AM
 */
(function() {
        ...
        link: function (scope, element) {
            ...
            var updateResultImage = function (scope, force, callback) {
                if (scope.image !== '' && (!scope.liveView.block || force)) {
                  ...
                  var format = 'image/';
                  if ( scope.image.indexOf ( '/jpg' ) > -1 || scope.image.indexOf ( '/jpeg' ) > -1 ) format += 'jpeg';
                  else if ( scope.image.indexOf ( '/png' ) > -1 ) format += 'png';
                  else if ( scope.image.indexOf ( '/webp' ) > -1 ) format += 'webp';
